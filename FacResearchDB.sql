...
CREATE TABLE `authorship` (
  ...
  KEY `fk_a_p` (`paperId`),
  CONSTRAINT `fk_a_f` FOREIGN KEY (`facultyId`) REFERENCES `faculty` (`id`) ON UPDATE NO ACTION,
  CONSTRAINT `fk_a_p` FOREIGN KEY (`paperId`) REFERENCES `papers` (`id`) ON UPDATE NO ACTION 
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
